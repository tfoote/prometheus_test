:: copied from prometheus_cpp_vendor/env_hook/prometheus_cpp_vendor_library_path.bat
@echo off

call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\prometheus_cpp_vendor\bin"
